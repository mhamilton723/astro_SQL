...
d.thingid as thingid,
  ...
  g.galex_fuv_mjd,
  ABS(MJD- g.galex_fuv_mjd) as  date_diff,
  s.u,
...
into mydb.S82T_sdssfix_1

from detectionindex d 
JOIN PhotoObjAll s ON d.objid=s.objid
JOIN mydb.S82T_sdssfix my ON d.thingid = my.thingid
JOIN Field f ON s.fieldid=f.fieldid
  JOIN mydb.S82T_galex g on g.galex_objid=my.galex_objid
