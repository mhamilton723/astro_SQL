...
INTO 
  S82T_sdss_galex_ukidss_wise

FROM
  Mydb.S82T_sdssfix s
  
JOIN mydb.S82T_galex g on s.old_sdss_dr8objid = g.sdss_dr8objid
JOIN mydb.S82T_ukidss_fix u on s.old_sdss_dr8objid = u.sdss_dr8objid
JOIN mydb.S82T_wise_fix w on s.old_sdss_dr8objid = w.old_sdss_dr8objid
