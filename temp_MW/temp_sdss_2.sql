IF (SELECT count(my.old_sdss_dr8objid) FROM mydb.$$SDSS_OUT$$ my WHERE my.old_sdss_dr8objid IN(select h.old_sdss_dr8objid from mydb.$$SDSS_OUT$$_1 h)) <> 0 and 
(SELECT count(my.old_sdss_dr8objid) FROM mydb.$$SDSS_OUT$$ my WHERE my.old_sdss_dr8objid IN(select a.matched_id from mydb.variable_SDSS_sources_xmatch a)) <> 0
...
from mydb.$$SDSS_OUT$$_1 my2

INNER JOIN mydb.$$SDSS_OUT$$ q ON q.old_sdss_dr8objid=my2.old_sdss_dr8objid

where my2.date_diff = (select min(date_diff) from mydb.$$SDSS_OUT$$_1 as f where f.old_sdss_dr8objid = my2.old_sdss_dr8objid) 
